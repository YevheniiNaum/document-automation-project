...
publishing {
    ...
    repositories {
        maven {
            url = uri("https://maven.pkg.jetbrains.space/naum-team-space/p/doc-auto/user-svc-api")
            credentials {
